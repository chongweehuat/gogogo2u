<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
			{!! App\Album::select('events') !!}
		</div>
		&nbsp;
		@if(App\Business::get('events.album_id'))
		<div id='renderimage'>
		<a href="/dashboard/uploadimages/?album_id={{App\Business::get('events.album_id')}}">
		<img src="{{App\Image::url(App\Album::find(App\Business::get('events.album_id'))->image_id)}}" style="max-width:300px;">
		</a>
		</div>
		@endif
