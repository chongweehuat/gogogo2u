<div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.title]', App\Business::get('mainpages.title'), array('id'=>'title','class'=>'form-control','placeholder'=>'Enter Title'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		{!!Form::label('abstract', 'Abstract', array('class'=>'col-sm-2 control-label required'))!!}
		<div class="col-md-10">	
		{!!Form::textarea('fn[mainpages.abstract]', App\Business::get('mainpages.abstract'), array('id'=>'abstract','class'=>'form-control','placeholder'=>'Enter Abstract','rows'=>3))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::textarea('fn[mainpages.body]', App\Business::get('mainpages.body'), array('id'=>'content','class'=>'form-control','rows'=>14,'placeholder'=>'Enter Content'))!!}
		</div>
		{!!Form::close()!!}
	</div>
...
$(document).ready(function() {
    var options = {
	 ...
	 $('body').delegate('#abstract','change', function(){
