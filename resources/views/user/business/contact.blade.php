<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.name]', App\Business::get('mainpages.name'), array('id'=>'name','class'=>'form-control','placeholder'=>'Enter Name'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.jobtitle]', App\Business::get('mainpages.jobtitle'), array('id'=>'jobtitle','class'=>'form-control','placeholder'=>'Enter Job Title'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.hpno]', App\Business::get('mainpages.hpno'), array('id'=>'hpno','class'=>'form-control','placeholder'=>'Enter HP No.'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.telno]', App\Business::get('mainpages.telno'), array('id'=>'telno','class'=>'form-control','placeholder'=>'Enter Tel. No.'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::email('fn[mainpages.email]', App\Business::get('mainpages.email'), array('id'=>'email','class'=>'form-control','placeholder'=>'Enter Email'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::email('fn[mainpages.wechat_url]', App\Business::get('mainpages.wechat_url'), array('id'=>'wechat_url','class'=>'form-control','placeholder'=>'Enter Wechat URL'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
...
function showLatest(){
	$.get( "/dashboard/business/wechat", function( data ){
