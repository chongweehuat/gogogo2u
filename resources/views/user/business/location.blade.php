<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.address]', App\Business::get('mainpages.address'), array('id'=>'address','class'=>'form-control','placeholder'=>'Enter Address'))!!}
		</div>
		{!!Form::close()!!}
		&nbsp;
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">
		{!!Form::text('fn[gps.latlng]', App\Business::get('gps.latlng'), array('id'=>'gpsinput', 'class'=>'form-control','placeholder'=>'Enter GPS Coordinate'))!!}
		</div>
		{!!Form::close()!!}
		&nbsp;
	</div>
...
function showResponse(response, statusText, xhr, $form)  { 	
    if(response.success == false)
    {
		...
		$("#rendergps").html('');
		$.get("/dashboard/business/gpslatlng", function( data ){
			$("#gpsinput").val(data);
		});
		showLatest();
    }
