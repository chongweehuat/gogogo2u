<div class="form-group">
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.website]', App\Business::get('mainpages.website'), array('id'=>'website','class'=>'form-control','placeholder'=>'Enter Website URL'))!!}
		</div>
		&nbsp;
		{!!Form::close()!!}
	</div>
	...
	<div class="form-group">
		...
		<div class="col-md-10">	
		{!!Form::text('fn[mainpages.facebook]', App\Business::get('mainpages.facebook'), array('id'=>'facebook','class'=>'form-control','placeholder'=>'Enter Facebook Business Page URL'))!!}
		</div>
		{!!Form::close()!!}
	</div>	
